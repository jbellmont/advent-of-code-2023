...
const getSumOfScratchcardPoints = async (
    ...
    try {
      ...
      const sumOfScratchcardPoints = scratchcards.reduce((totalGamePoints, currentGame) => {
        ...
        const pointsForCurrentGame = numbersYouHave.reduce((currentGamePoints, currentNumber) => {
